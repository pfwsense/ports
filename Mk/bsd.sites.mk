...
git-clone-DEFAULT: ${_GITHUB_CLONE_DIR}
	@git clone https://ghproxy.com/https://github.com/${GH_ACCOUNT_DEFAULT}/${GH_PROJECT_DEFAULT}.git ${_GITHUB_CLONE_DIR}/${GH_PROJECT_DEFAULT}
...
git-clone-${_group}: ${_GITHUB_CLONE_DIR}
	@git clone https://ghproxy.com/https://github.com/${GH_ACCOUNT_${_group}}/${GH_PROJECT_${_group}}.git ${_GITHUB_CLONE_DIR}/${GH_PROJECT_${_group}}
...
WWW?=	https://ghproxy.com/https://github.com/${GH_ACCOUNT}/${GH_PROJECT}/
...
MASTER_SITE_PYTHON+= \
	https://mirrors.huaweicloud.com/%SUBDIR%/ \
